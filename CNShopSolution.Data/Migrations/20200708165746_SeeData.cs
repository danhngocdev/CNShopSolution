    ...
    public partial class SeeData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterColumn<DateTime>(
                ...
                table: "Orders",
                nullable: false,
                defaultValue: new DateTime(2020, 7, 8, 23, 57, 46, 226, DateTimeKind.Local).AddTicks(6470),
                oldClrType: typeof(DateTime),
                oldType: "datetime2",
                oldDefaultValue: new DateTime(2020, 7, 8, 23, 28, 34, 923, DateTimeKind.Local).AddTicks(4189));
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "CreateDate", "OriginalPrice", "Price", "SeoAlias" },
                values: new object[] { 1, new DateTime(2020, 7, 8, 23, 57, 46, 240, DateTimeKind.Local).AddTicks(5153), 100000m, 200000m, null });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterColumn<DateTime>(
                ...
                type: "datetime2",
                nullable: false,
                defaultValue: new DateTime(2020, 7, 8, 23, 28, 34, 923, DateTimeKind.Local).AddTicks(4189),
                oldClrType: typeof(DateTime),
                oldDefaultValue: new DateTime(2020, 7, 8, 23, 57, 46, 226, DateTimeKind.Local).AddTicks(6470));
        }
    }
}
